...
<details open>
<summary><b>2025年-5月</b></summary>
	
日期  | 类型 |  更新内容
------- | :--: | :-------
04-20 | 更新 | 优化班级添加成员逻辑,增加判断机制,判断管理员添加班级成员时输入的账号是否存在,不存在则跳过成员添加,并在前台予以输出.
05-17 | 更新 | 商城逻辑更新,由原来的"购买商品申请后,管理端同意并发货后再进行扣除相应金币"改为"发送购买商品申请的同时扣除相应金币,若管理端进行积分退回才返还相应金币",防止部分成员出现金币为负的情况来卡Bug.
05-17 | 更新 | 管理端日志查看更新,新增成员商品购买记录以及对应的操作人员.同时修复点击"其他"选项时显示为空的问题.
</details>
...
日期  | 类型 |  更新内容
------- | :--: | :-------
02-20 | 更新 | 后台班级成员批量添加新增成员判断逻辑,防止该学生被多次录入班级导致重复.
02-19 | 新增 | 后台班级新增"开启代码查看"功能(管理员),开启后,该班级的管理员可以查看班级成员的提交详细记录.
02-09 | 修复 | 修复了题目导入时题目无法评判的问题.
02-09 | 修复 | 修复了提交记录判题结果显示错误的问题.
02-09 | 修复 | 修复了当删除题目后主页的两个echarts图表显示错误的问题.
02-07 | 更新 | 更新主页样式,活动区域新增Rating排名(前三),且活动标题使用走马灯样式.
02-03 | 更新 | 更新主页样式,签到显示连签和累签,题目显示今AC和累计AC.
02-02 | 新增 | 新增个人战绩查看竞赛Rating变化功能,包括变化趋势和数据.
02-02 | 新增 | 新增竞赛Rating的功能,计算方式参照CF的计算标准.
</details>

<details>
<summary><b>2025年-1月</b></summary>
	
日期  | 类型 |  更新内容
------- | :--: | :-------
01-22 | 修复 | 修复了使用题号调整功能时题目的多重样例没有更新导致丢失的问题.
01-22 | 修复 | 修复了部分服务器第一次答对某道题后金币值不增加的问题.
01-19 | 修复 | 修正了逻辑,若您是管理员,不管您是否是代码查看者,您都可以查看判题结果的详细信息.
01-19 | 修复 | 修复了管理员但不是代码查看者情况下判题结果显示异常的问题.
01-19 | 更新 | 修改邮件逻辑:若该成员申请或退出班级,如果接收端绑定了电子邮件,则不会发送OJ系统通知.
01-19 | 新增 | 新增班级管理员账号下若有新的成员审核请求时,"班级列表"区域变黄提醒.
01-19 | 更新 | 重绘班级列表旧版表格页面,管理员增加管理班级入口.
01-19 | 修复 | 修复了在部分状态下,查找知识点时根据记忆数据显示为空的问题.
01-05 | 修复 | 修复了当没有班级绑定知识点时，非管理员用户的题目列表不显示题目的问题.
01-05 | 更新 | 金币商城功能缩略图点击放大样式已修改为LayUI样式.
01-04 | 更新 | 竞赛列表分类筛选,同时更新了管理员竞赛发布逻辑.
01-01 | 新增 | 新增支持添加题目展示多重展示数据功能.
</details>
...
日期  | 类型 |  更新内容
------- | :--: | :-------
12-30 | 新增 | 消息新增"全员禁言"功能(实验性)
12-23 | 新增 | 个性设置支持设置代码字体.
12-20 | 更新 | 更新竞赛参加逻辑.
12-17 | 新增 | 新增竞赛报名参加功能.
12-17 | 新增 | 新增竞赛成绩补录功能.
...
日期  | 类型 |  更新内容
------- | :--: | :-------
11-28 | 修复 | 修复班级对应人数显示不正确的问题.
11-28 | 修复 | 修复金币-商城中购买GET参数出现Bug的问题.
11-28 | 新增 | 消息功能对于管理员,新增"全员广播"栏,可以为所有用户发起相同的消息.
11-22 | 更新 | 对于学生用户,限制内邮功能的收件人(联系人)范围.
11-22 | 更新 | 启用OJ内邮功能,并优化了bshark内邮模板.
